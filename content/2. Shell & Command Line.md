...
## 📝 Section 2: Shell & Command Line (Complete)
...
### 16. `find` — Search for Files by NAME
...
### 18. `grep` — Search Text INSIDE Files
...
### 19. `awk` — Field Extraction & Processing
...
### 21. `uniq` — Count/Remove Duplicates
...
### 22. `head` and `tail` — View File Portions
...
### 23. `wc` — Word/Line/Character Count
...
### 24. Shell Pipeline — Combining Commands
...
### 25. `dir /ah` — Windows Command (NOT Unix)
...
### 26. Other Essential Shell Commands
...
### 28. `grep` for Log Analysis — Exam Scenarios
